          ...
          <Card className="shadow-xl">
            <CardContent className="p-8">
              ...
              <p className="text-lg leading-relaxed text-muted-foreground text-right mt-4">
                פרופ' בייגל הוביל יוזמות חינוכיות ומחקריות רבות במסגרת האיגוד הקרדיולוגי בישראל. בעברו גם היה יו"ר החוג לטיפול נמרץ לב באיגוד הקרדיולוגי. הוא משמש כמרצה קבוע בפקולטה לרפואה של אוניברסיטת תל אביב ונבחר שוב ושוב לרשימות הרופאים המצטיינים של מגזין Forbes.
              </p>
            </CardContent>
          </Card>
        </div>
